    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">Company Info:
                        </h4>
                    ...
                    <div class="col-xs-4">
                        <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">Supplier Info:
                        </h4>
                    ...
                    <div class="col-xs-4">
                        <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">Invoice Info:
                        </h4>
                ...
                <div class="row">
                    <div class="col-xs-4 col-xs-offset-8">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td class="left"><strong>Discount ({{ $purchase->discount_percentage }}%)</strong>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="right"><strong>{{ format_currency($purchase->total_amount) }}</strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
