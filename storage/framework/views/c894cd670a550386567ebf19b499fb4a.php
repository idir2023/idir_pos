                            ...
                            <div class="form-row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_name" required value="<?php echo e($product->product_name); ?>">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label for="product_code">Code <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="product_code" required value="<?php echo e($product->product_code); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_quantity" required value="<?php echo e($product->product_quantity); ?>" min="1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">Alert Quantity <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="product_stock_alert" required value="<?php echo e($product->product_stock_alert); ?>" min="0">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_order_tax" value="<?php echo e($product->product_order_tax); ?>" min="0" max="100">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\important files\idir_pos\Modules/Product\Resources/views/products/edit.blade.php ENDPATH**/ ?>