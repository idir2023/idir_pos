...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <form id="payment-form" action="<?php echo e(route('sale-payments.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="form-row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="reference" required readonly value="INV/<?php echo e($sale->reference); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\idir_pos\Modules/Sale\Resources/views/payments/create.blade.php ENDPATH**/ ?>