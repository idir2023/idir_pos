        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--[if BLOCK]><![endif]--><?php if(session()->has('discount_message' . $cart_item->id)): ?>
                    ...
                    <div class="form-group">
                        <!--[if BLOCK]><![endif]--><?php if($discount_type[$cart_item->id] == 'percentage'): ?>
...
<?php /**PATH C:\Users\lenovo\Desktop\important files\triangle-pos\resources\views/livewire/includes/product-cart-modal.blade.php ENDPATH**/ ?>